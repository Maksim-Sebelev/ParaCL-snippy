...
SPECIALIZE_CREATE(last::node::Return             , __VA_ARGS__)                                                                \
SPECIALIZE_CREATE(last::node::FunctionCall       , __VA_ARGS__)                                                                \
SPECIALIZE_CREATE(last::node::FunctionDeclaration, __VA_ARGS__)
